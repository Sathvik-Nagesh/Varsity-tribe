        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-[540px]">
            ...
            <motion.div variants={fadeUp} className="mt-8 flex items-center gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <span className="text-small text-brand-text-secondary"><strong className="text-brand-text-primary">2,847</strong> learning now</span>
              </div>
              <div className="h-4 w-px bg-brand-border" />
              <span className="text-small text-brand-text-secondary"><strong className="text-brand-text-primary">342</strong> discussions today</span>
              <div className="h-4 w-px bg-brand-border hidden sm:block" />
              <span className="text-small text-brand-text-secondary hidden sm:inline"><strong className="text-brand-text-primary">8</strong> events this week</span>
            </motion.div>
          </motion.div>
          ...
          <div className="relative hidden lg:flex items-center justify-center min-h-[500px]">
            ...
            <motion.div
              ...
              className="glass-strong rounded-2xl p-5 w-[280px] shadow-xl animate-float-slow"
            >
            ...
            <motion.div
              ...
              className="absolute top-4 right-0 glass-strong rounded-xl p-4 w-[200px] shadow-lg animate-float-delayed"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-12 -left-4 glass-strong rounded-xl p-3 shadow-lg animate-float"
            >
              <div className="flex items-center gap-2">
            ...
            <motion.div
              ...
              className="absolute bottom-0 right-8 glass-strong rounded-xl p-3 shadow-lg animate-float-slow" style={{ animationDelay: '2s' }}
            >
              <div className="flex items-center gap-2">
